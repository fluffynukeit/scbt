...
infix 6 :<=:
data (:=>:) = (:=>:) E -- Algorithmic synthesis, Figure 14a
data (:>>:) = (:>>:) (S ::: A, SmallP) -- Algorithmic spine typing, Figure 14a
data (:>>?:) = (:>>?:) (S ::: A, SmallP) -- Algorithmic spine typing with principality recovery, Figure 14a
